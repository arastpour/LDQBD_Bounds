function [R_lowerbar, R_upperbar, m] = function_R_low_and_up(epsilon_r,ell, maxPhase, lambda1, lambda2, mu1, mu2, gamma1, gamma2, c, m_initial)
    ...
    continue_r = true(1);
    m = m_initial;
    %m = 200; %I could have started from 0, but I start from 2 because I refer to m-2 below
    while continue_r
        W1 = zeros((m-1)*Msize, 2*Msize); %see Help_R calculations.jpg for more info about the structure of W1 and W2
